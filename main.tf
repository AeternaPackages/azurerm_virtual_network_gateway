...
module "virtual_network_gateways" {
  source                   = "git::https://github.com/AeternaModules/azurerm_virtual_network_gateway.git?ref=v5.0.0"
  virtual_network_gateways = local.virtual_network_gateways
}

module "virtual_network_gateway_connections" {
  source                              = "git::https://github.com/AeternaModules/azurerm_virtual_network_gateway_connection.git?ref=v5.0.0"
...
module "virtual_network_gateway_nat_rules" {
  source                            = "git::https://github.com/AeternaModules/azurerm_virtual_network_gateway_nat_rule.git?ref=v5.0.0"
